...
public class UserController {
     ...
     * - Persists the user via the service layer.<br>
     * - Maps the saved entity to a response DTO.<br>
     ...
     * Retrieves all users.
     * <p>
     * - Fetches all user entities from the database.<br>
     * - Maps them to {@link UserInfoResponse} DTOs.<br>
     ...
     * <p>
     * - Extracts the {@code username} from the path variable.<br>
     * - Fetches the corresponding user entity from the service.<br>
     * - Maps it to a {@link UserInfoResponse}.<br>
     * - Returns the result in a standardized API response.
     *
     ...
     * <p>
     * - Extracts the {@code username} from the path.<br>
     * - Accepts updated user information in the request body.<br>
     * - Calls the service to perform the update.<br>
     * - Maps the updated entity to a response DTO.<br>
     * - Returns the updated user info wrapped in a standardized API response.
     *
