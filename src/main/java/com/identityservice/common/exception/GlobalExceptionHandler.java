...
/**
 * Global exception handler to handle all application-wide exceptions.
 * This class ensures consistent API responses for both expected and unexpected errors.
 */
@ControllerAdvice
public class GlobalExceptionHandler {

    /**
     * Handle unexpected RuntimeExceptions (uncaught system errors).
     *
    ...
    /**
     * Handle validation errors triggered by @Valid annotations in request DTOs.
     * Collects all field-level validation messages into a structured map.
     *
